...
/** Read a configuration value under the `openrouterModelManager` namespace. */
function getConfig<T>(key: string, defaultValue: T): T {
  return vscode.workspace.getConfiguration('openrouterModelManager').get<T>(key, defaultValue);
}
      ...
      const req = https.request(
        {
          ...
          headers: {
            ...
            'HTTP-Referer': 'https://github.com/husamettinulutas/openrouter-copilot-model-manager',
            'X-Title': 'VS Code OpenRouter Copilot Extension',
          },
        },
        (res) => {
